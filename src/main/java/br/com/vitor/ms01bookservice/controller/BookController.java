...
public class BookController {
    ...
    public ResponseEntity<BookResponse> findBook(@PathVariable("id") Long id, @PathVariable("currency") String currency) {
        return ResponseEntity.ok(mapper.bookToBookresponse(bookService.findBook(id, currency)));
    }
}
